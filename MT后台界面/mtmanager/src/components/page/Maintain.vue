     ...
     <div class="table">
        <div class="container">
            <div class="handle-box">
                ...
                <el-input v-model="names" :clearable = 'true' placeholder="服务名" class="handle-input mr10" ></el-input>
             ...
             <el-table :data="tableData" style="width: 100%" @selection-change="handleSelectionChange">
                ...
                <el-table-column label="服务名称" prop="goodsName" width="180"></el-table-column>
                <el-table-column label="服务分类" prop="category" ></el-table-column>
         ...
         <!-- 新增弹出框 -->
        <el-dialog title="新增服务" :visible.sync="addVisible" width="70%" @closed="cancalAdd">
            <div>
            <el-steps :active="active" finish-status="success">
                <el-step title="服务名称"></el-step>
                <el-step title="所属分类"></el-step>
                <el-step title="所属品牌"></el-step>
                <el-step title="服务展示图"></el-step>
                <el-step title="服务详情图"></el-step>
            ...
            <el-form ref="addform" :model="addform" label-width="70px">
                <div style="margin-top: 30px;" id="s0">
                    <el-form-item label="服务名称">
                        <el-input v-model="goodsname" autocomplete="off" placeholder="服务名称" class="handle-select1 mr10"></el-input>
                    </el-form-item>
                </div>
...
// -----------------------------------------------------------------------------------------------------------------------------------添加服务
        saveAdd(){
            ...
            this.showcropImgs=[];//服务展示图片
            this.othercropImgs=[];//服务详情图片
            this.norms=[];//基础属性
            this.otherImgSrc = '';
            this.showImgSrc = '';
            document.getElementById('s0').removeAttribute('hidden');
