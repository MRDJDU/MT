...
//-------------------------------------------------------列表数据
    ...
    methods: {
        ...
        addbaseNormsSubmit(formName){
               // 提交新增品牌
                this.axios.post('mt/BaseNorms/addBaseNorms',{
        ...
        DeletebaseNorms(e){
            ...
            this.$confirm('此操作将永久删除该基础属性, 是否继续?', '提示', {
                ...
                type: 'warning'
                    ...
                    // 删除新增品牌
                    this.axios.post('mt/BaseNorms/deleteBaseNorms',{
                        "baseNorms_id":id
                    })
                    .then(response => {
                        if(response.data.statuCode){
...
// --------------------------------------------------------------------------------------------
        ...
        DeletebaseSKU(e){
            ...
            this.$confirm('此操作将永久删除该库存计量属性, 是否继续?', '提示', {
                ...
                type: 'warning'
                    ...
                    // 删除新增品牌
                    this.axios.post('mt/BaseSKU/deleteBaseSKU',{
                        "baseSKU_id":id
                    })
                    .then(response => {
                        if(response.data.statuCode){
        ...
        getbaseSKU(){
            // 获取新增品牌
            this.axios.post('mt/BaseSKU/getBaseSKUPage',{
                "baseSKUDto":{
                    "categoryThird_id":this.fatherId
                },
                "myPagaRequest":{
...
// ---------------------------------------------------一级分类------------------------------------------------------
       // 分页行点击触发事件，val是点击的页数
        ...
        oneDeletehandleClick(one){
            this.axios.post('mt/categoryFirst/deleteCategoryFirst',{
        ...
        oneShowClick(one){
           this.axios.post('mt/categoryFirst/lockCategoryFirst',{
                "categoryFirst_id":one.categoryFirst_id
            })
            .then(response => {
                if(response.data.statuCode){
        ...
        addOneSubmit(){
            ...
            if(this.value2){
             ...
             // 提交新增一级分类
            this.axios.post('mt/categoryFirst/addCategoryFirst',{
...
//--------------------------------------------------------------------------二级分类
        ...
        twoDeletehandleClick(two){
             this.axios.post('mt/categorySecond/deleteCategorySecond',{
        ...
        twoShowClick(two){
            this.axios.post('mt/categorySecond/lockCategorySecond',{
                 "categorySecond_id":two.categorySecond_id
            })
            .then(response => {
                if(response.data.statuCode){
        ...
        addTwoSubmit(){
            ...
            if(this.addTwoForm.twoname==null ||this.addTwoForm.twoname == ''||this.addTwoForm.twoname==' '){
             ...
             // 提交新增二级分类
            this.axios.post('mt/categorySecond/addCategorySecond',{
...
//--------------------------------------------------------------------------三级分类
        ...
        threeDeletehandleClick(three){
             this.axios.post('mt/categoryThird/deleteCategoryThird',{
        ...
        threeShowClick(three){
            this.axios.post('mt/categoryThird/lockCategoryThird',{
                "categoryThird_id":three.categoryThird_id
            })
            .then(response => {
                if(response.data.statuCode){
